...
* **🤖 Natural Language and Open-Ended Questions:** As Monocle is backed by an LLM, queries passed to it are written in plain text (e.g. ```memory corruption vulnerabilities```.
